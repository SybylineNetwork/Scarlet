...
public interface AvatarSearch_VRCDS
{
    ...
    {
        try (HttpURLInputStream in = HttpURLInputStream.post(API_ROOT+"/v1/vrchat/avatars/store/putavatarExternal", ExtendedUserAgent.init_conn_json, HttpURLInputStream.writeAsJson(null, null, PutAvatarExternalRequest.class, new PutAvatarExternalRequest(id, userid))))
        {
        }
