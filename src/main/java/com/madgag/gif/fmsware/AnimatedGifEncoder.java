...
public class AnimatedGifEncoder {
  ...
  public void setBackground(Color c) {
    ...
    public boolean addFrame(BufferedImage im) {
        return this.addFrame(im, false);
    }
	public boolean addFrame(BufferedImage im, boolean scaleToFit) {
		if ((im == null) || !started) {
			return false;
		}
		boolean ok = true;
		try {
			...
			image = im;
			getImagePixels(scaleToFit); // convert to correct format if necessary
	 ...
	 */
	protected void getImagePixels(boolean scaleToFit) {
...
if (scaleToFit && (w != width || h != height))
{
	g.scale((double)width / (double)w, (double)height / (double)h);
}
